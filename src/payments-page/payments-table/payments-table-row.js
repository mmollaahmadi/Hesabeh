    ...
    return (
      <Col xs='12' className='px-2 p-lg-0 m-1 m-lg-0'>
        <Row className="m-0">
          ...
          <Col xs='6' lg="3" className=" table-row-col justify-content-lg-center my-auto">
          ...
          <Col xs='6' lg="2" className="table-row-col justify-content-lg-center my-auto">
            <span className='d-lg-none ml-2'>قیمت: </span>
            <span>{this.props.data.value}</span>
          </Col>

          <Col xs='12' className="d-lg-none table-row-col my-auto">
            <span className='ml-2'>توضیح: </span>
            <span>{this.props.data.description}</span>
          </Col>

          <Col xs='12' lg="3" className="table-row-col justify-content-lg-center my-auto">
            <span className='d-lg-none ml-2'>انجام دهندگان: </span>
            <Chip
              link="/mollaahmadi.ir"
              haveCloseButton="false"
              avatarSrc={require("../../assets/img/users/user01.jpg")}
          ...
          <Col lg="2" className="table-row-col justify-content-lg-center my-auto flex-grow-1">
