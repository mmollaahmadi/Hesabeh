    ...
    return (
      <Col lg='12' className='d-none d-lg-block px-0'>
        <Row className="notifications-table-header m-0">
          <Col  className="notifications-table-header-col px-0 check-width">
            <div
          ...
          <Col lg="2" className="notifications-table-header-col      flex-grow-1">
            <p>مصرف کنندگان</p>
          </Col>
          <Col sm="12" className="notification-table-header-line"/>
        </Row>
      </Col>
    );
  }
