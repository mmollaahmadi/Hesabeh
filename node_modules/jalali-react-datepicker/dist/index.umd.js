(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('stream'), require('prop-types'), require('react-dom')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'stream', 'prop-types', 'react-dom'], factory) :
    (global = global || self, factory(global.umd = {}, global.React, global.stream, global.PropTypes, global.ReactDom));
}(this, function (exports, React, stream, PropTypes, ReactDOM) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    (function (global, factory) {
       ...
       factory(global.moment);
        ...
        var fa = moment$$1.defineLocale('fa', {
    ...
    var index$1 = memoize$1(reactPropsRegex.test.bind(reactPropsRegex));

    var isPropValid_cjs = index$1;
    ...
    var ThemeProvider = function (_Component) {
      ...
      function ThemeProvider(props) {
        ...
        _this.getContext = memoizeOne_cjs(_this.getContext.bind(_this));
    ...
    var StyleSheetManager = function (_Component) {
      ...
      function StyleSheetManager(props) {
        ...
        _this.getContext = memoizeOne_cjs(_this.getContext);
        return _this;
      }
    ...
    var StyledComponent = function (_Component) {
      ...
      StyledComponent.prototype.renderInner = function renderInner(theme) {
        ...
        for (key in computedProps) {
          ...
          if (key === 'forwardedComponent' || key === 'as') continue;else if (key === 'forwardedRef') propsForElement.ref = computedProps[key];else if (!isTargetTag || isPropValid_cjs(key)) {
    ...
    var _a = styledComponents, styled$1 = _a.default, ThemeProvider$1 = _a.ThemeProvider;
    ...
    // prettier-ignore
    var inputFaDateMask = [/[0-1]/, /[0-4]/, /[0-9]/, /[0-9]/, '/', /[0-1]/, /[0-9]/, '/', /[0-3]/, /[0-9]/];
    // prettier-ignore
    var inputFaDateWithTimeMask = [/[0-1]/, /[0-4]/, /[0-9]/, /[0-9]/, '/', /[0-1]/, /[0-9]/, '/', /[0-3]/, /[0-9]/, ' ', '-', ' ', /[0-2]/, /[0-9]/, ':', /[0-5]/, /[0-9]/];
    var formatDateTime = "jYYYY/jMM/jDD - HH:mm";
    var formatDate = "jYYYY/jMM/jDD";
    // week days name
    var weekDayNames = ["ش", "ی", "د", "س", "چ", "پ", "ج"];
    // format jalali string date into moment
    var formatJalaliDate = function (date) {
        var formattedDate = jalaliMoment("" + date, "jYYYY/jMM/jDD");
    ...
    var checkDateMonth = function (date, current) { return current.jMonth() < date.jMonth(); };
    var checkCurrentMonth = function (date) {
        return jalaliMoment().format("jYYYY/jMM") === date.format("jYYYY/jMM");
    };
    var daysInMonth = function (date) {
        var days = [];
        var clonedDate = date.clone();
        var monthName = clonedDate.locale("fa").format("jMMMM") + " " + fa$1(clonedDate.format("jYYYY"));
        var month = Number(date
            .clone()
            .locale("fa")
            .format("jM"));
        var firstDayOfWeek = date.clone().startOf("jMonth");
        var lastDayOfWeek = date.clone().endOf("jMonth");
        var today = checkCurrentMonth(date) ? { today: date.format("jDD") } : null;
        ...
        return __assign({ monthName: monthName, month: month, days: days }, today);
    };

    var NormalDay = styled$1("td")(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  height: 45px;\n  width: 45px;\n  text-align: center;\n  cursor: pointer;\n  position: relative;\n  transform-style: preserve-3d;\n  border-radius: ", ";\n  color: ", ";\n  background-color: ", ";\n"], ["\n  height: 45px;\n  width: 45px;\n  text-align: center;\n  cursor: pointer;\n  position: relative;\n  transform-style: preserve-3d;\n  border-radius: ", ";\n  color: ",
        ";\n  background-color: ",
        ";\n"])), function (props) { return props.theme.daysRound; }, function (props) {
        return props.selectedDay ? props.theme.selectDayColor : props.theme.daysColor;
    }, function (props) {
        return props.selectedDay
            ? props.theme.selectDayBackColor
            : props.theme.daysBackColor;
    });
    var HolidayDay = styled$1(NormalDay)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  color: ", ";\n  background-color: ", ";\n"], ["\n  color: ",
        ";\n  background-color: ",
        ";\n"])), function (props) {
        return props.selectedDay ? props.theme.selectDayColor : props.theme.holidaysColor;
    }, function (props) {
        return props.selectedDay
            ? props.theme.selectDayBackColor
            : props.theme.holidaysBackColor;
    });
    var StartEndRangeDay = styled$1(NormalDay)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  color: ", ";\n  background-color: ", ";\n  border-radius: ", ";\n  z-index: ", ";\n  ", ";\n  ", ";\n"], ["\n  color: ",
        ";\n  background-color: ",
        ";\n  border-radius: ",
        ";\n  z-index: ", ";\n  ",
        ";\n  ",
        ";\n"])), function (props) {
        return props.isSelecting && props.startEndRange.status === "endRange"
        ...
        return props.startEndRange.status === "continueRange" ? 0 : props.theme.daysRound;
    }, function (props) { return props.startEndRange.status === "continueRange" && 100; }, function (props) {
        return props.startEndRange.status === "startRange" &&
            "\n\t\t\t&:after {\n\t\t\t\tcontent: \"\";\n\t\t\t\tdisplay: block;\n\t\t\t\twidth: 25px;\n\t\t\t\theight: 45px;\n\t\t\t\tposition: absolute;\n\t\t\t\ttop: 45px;\n\t\t\t\tbackground-color: " + props.theme.continueRangeBackColor + "\n\t\t\t\ttransform: translate3d(-25px, -45px, -1px);\n\t\t\t}\n\t\t";
    }, function (props) {
        return props.startEndRange.status === "endRange" &&
            "\n\t\t\t&:after {\n\t\t\t\tcontent: \"\";\n\t\t\t\tdisplay: block;\n\t\t\t\twidth: 25px;\n\t\t\t\theight: 45px;\n\t\t\t\tposition: absolute;\n\t\t\t\ttop: 45px;\n\t\t\t\tbackground-color: " + props.theme.continueRangeBackColor + "\n\t\t\t\ttransform: translate3d(0px, -45px, -1px);\n\t\t\t}\n\t\t";
    });
    var Day = function (props) {
        var startEndRange = props.startEndRange, holiday = props.holiday, daysEvent = props.daysEvent;
        if (startEndRange && Object.keys(startEndRange).length) {
            return React.createElement(StartEndRangeDay, __assign({}, props, daysEvent()));
        }
        else if (holiday.length) {
            return React.createElement(HolidayDay, __assign({}, props, daysEvent()));
        }
        return React.createElement(NormalDay, __assign({}, props, daysEvent()));
    };
    ...
    var DaysBody = styled$1("div")(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  max-width: 310px;\n  max-height: 85%;\n  position: relative;\n  overflow: scroll;\n  border-radius: ", "rem;\n  background-color: ", ";\n  & * {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n    user-select: none;\n  }\n"], ["\n  max-width: 310px;\n  max-height: 85%;\n  position: relative;\n  overflow: scroll;\n  border-radius: ", "rem;\n  background-color: ", ";\n  & * {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n    user-select: none;\n  }\n"])), 8 / 16, function (props) { return props.theme.backColor; });
    var DaysHead = styled$1("div")(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  padding-top: ", "rem;\n  background-color: ", ";\n"], ["\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  padding-top: ", "rem;\n  background-color: ", ";\n"])), 24 / 16, function (props) { return props.theme.headBackColor; });
    var HeadTitle = styled$1("h4")(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  padding: 0 ", "rem;\n  font-size: 1.618rem;\n  text-align: center;\n  color: ", ";\n\n  svg {\n    fill: ", ";\n  }\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  padding: 0 ", "rem;\n  font-size: 1.618rem;\n  text-align: center;\n  color: ", ";\n\n  svg {\n    fill: ", ";\n  }\n"])), 8 / 16, function (props) { return props.theme.headTitleColor; }, function (props) { return props.theme.headTitleColor; });
    var HeadRange = styled$1("h3")(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  margin-top: ", "rem;\n  margin-bottom: 1rem;\n  font-size: 1.618rem;\n  border-radius: ", "rem;\n  padding: 0 ", "rem;\n  background-color: ", ";\n  color: ", ";\n"], ["\n  margin-top: ", "rem;\n  margin-bottom: 1rem;\n  font-size: 1.618rem;\n  border-radius: ", "rem;\n  padding: 0 ", "rem;\n  background-color: ", ";\n  color: ", ";\n"])), 24 / 16, 20 / 16, 8 / 16, function (props) { return props.theme.headRangeBackColor; }, function (props) { return props.theme.headRangeColor; });
    var Table = styled$1("table")(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  width: 100%;\n  font-size: 1rem;\n  border-collapse: separate;\n  border-spacing: 0 0.5rem;\n  padding: ", ";\n\n  th {\n    font-size: 1rem;\n    font-weight: 300;\n    color: ", ";\n  }\n"], ["\n  width: 100%;\n  font-size: 1rem;\n  border-collapse: separate;\n  border-spacing: 0 0.5rem;\n  padding: ", ";\n\n  th {\n    font-size: 1rem;\n    font-weight: 300;\n    color: ", ";\n  }\n"])), function (props) { return (props.timePicker ? 8 / 16 + "rem" : 0); }, function (props) { return props.theme.weekDaysColor; });
    var ButtonsDiv = styled$1("div")(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  margin-top: ", "rem;\n  margin-bottom: ", "rem;\n\n  button {\n    border: none;\n    margin: 0;\n    padding: ", "rem ", "rem;\n    width: auto;\n    min-width: 80px;\n    overflow: visible;\n    font: inherit;\n    line-height: normal;\n    appearance: none;\n    outline: 0;\n    border-radius: ", "rem;\n    cursor: pointer;\n    &::-moz-focus-inner {\n      border: 0;\n      padding: 0;\n      outline: 0;\n    }\n  }\n  .rdp__button--cancel {\n    margin-right: 1rem;\n    color: ", ";\n    background-color: ", ";\n    transition: background-color 0.2s ease;\n    &:hover,\n    &:focus {\n      color: ", ";\n      background-color: ", ";\n    }\n  }\n  .rdp__button--submit {\n    margin-right: 1rem;\n    color: ", ";\n    background-color: ", ";\n    transition: background-color 0.2s ease;\n    &:hover,\n    &:focus {\n      color: ", ";\n      background-color: ", ";\n    }\n  }\n"], ["\n  margin-top: ", "rem;\n  margin-bottom: ", "rem;\n\n  button {\n    border: none;\n    margin: 0;\n    padding: ", "rem ", "rem;\n    width: auto;\n    min-width: 80px;\n    overflow: visible;\n    font: inherit;\n    line-height: normal;\n    appearance: none;\n    outline: 0;\n    border-radius: ", "rem;\n    cursor: pointer;\n    &::-moz-focus-inner {\n      border: 0;\n      padding: 0;\n      outline: 0;\n    }\n  }\n  .rdp__button--cancel {\n    margin-right: 1rem;\n    color: ", ";\n    background-color: ", ";\n    transition: background-color 0.2s ease;\n    &:hover,\n    &:focus {\n      color: ", ";\n      background-color: ", ";\n    }\n  }\n  .rdp__button--submit {\n    margin-right: 1rem;\n    color: ", ";\n    background-color: ", ";\n    transition: background-color 0.2s ease;\n    &:hover,\n    &:focus {\n      color: ", ";\n      background-color: ", ";\n    }\n  }\n"])), 16 / 16, 16 / 16, 8 / 16, 24 / 16, 4 / 16, function (props) { return props.theme.cancelColor; }, function (props) { return props.theme.cancelBackColor; }, function (props) { return props.theme.cancelHoverColor; }, function (props) { return props.theme.cancelHoverBackColor; }, function (props) { return props.theme.submitColor; }, function (props) { return props.theme.submitBackColor; }, function (props) { return props.theme.submitHoverColor; }, function (props) { return props.theme.submitHoverBackColor; });
    var ChangeViewButton = styled$1("button")(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  min-width: 40px !important;\n  min-height: 40px;\n  float: left;\n  margin-left: 16px !important;\n  text-align: center;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  transition: background-color 0.2s ease;\n  background-color: ", ";\n  svg {\n    fill: ", ";\n  }\n  &:hover {\n    background-color: ", ";\n    svg {\n      fill: ", ";\n    }\n  }\n"], ["\n  min-width: 40px !important;\n  min-height: 40px;\n  float: left;\n  margin-left: 16px !important;\n  text-align: center;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  transition: background-color 0.2s ease;\n  background-color: ", ";\n  svg {\n    fill: ", ";\n  }\n  &:hover {\n    background-color: ", ";\n    svg {\n      fill: ", ";\n    }\n  }\n"])), function (props) { return props.theme.changeViewButtonBackColor; }, function (props) { return props.theme.changeViewButtonColor; }, function (props) { return props.theme.changeViewButtonHoverBackColor; }, function (props) { return props.theme.changeViewButtonHoverColor; });
    var boolDataset = function (arg) {
        if (arg) {
            return {
                "data-disable": arg,
            };
    ...
    var Days = /** @class */ (function (_super) {
        ...
        Days.prototype.render = function () {
            var _this = this;
            var _a = this.props, days = _a.days, theme = _a.theme, rangeDays = _a.rangeDays, daysEventListeners = _a.daysEventListeners, selectedPickerStatus = _a.selectedPickerStatus, ArrowLeft = _a.ArrowLeft, ArrowRight = _a.ArrowRight, ClockIcon = _a.ClockIcon, DateIcon = _a.DateIcon, monthName = _a.monthName, increaseMonth = _a.increaseMonth, decreaseMonth = _a.decreaseMonth, isSelecting = _a.isSelecting, isRenderingButtons = _a.isRenderingButtons, onCancelButton = _a.onCancelButton, onSubmitButton = _a.onSubmitButton, selectedDay = _a.selectedDay, timePicker = _a.timePicker, timePickerView = _a.timePickerView, toggleView = _a.toggleView;
            if (!days.length) {
                return null;
            }
            var weeks = chunk(days, 7);
            return (React.createElement(ThemeProvider$1, { theme: theme },
                React.createElement(DaysBody, null,
                    timePicker && timePickerView ? (React.createElement("p", { "data-testid": "dp__timePicker" }, "time picker")) : (React.createElement(React.Fragment, null,
                        React.createElement(DaysHead, { "data-testid": "days-head" },
                            React.createElement(HeadTitle, { "data-testid": "days-head-title" },
                                React.createElement(ArrowRight, { onClick: decreaseMonth }),
                                React.createElement("p", { "data-testid": "days-head-title-text" }, monthName),
                                React.createElement(ArrowLeft, { onClick: increaseMonth })),
                            React.createElement(HeadRange, { "data-testid": "days-head-range" }, selectedPickerStatus)),
                        React.createElement(Table, { "data-testid": "table-days", timePicker: timePicker },
                            React.createElement("thead", null,
                                React.createElement("tr", null, weekDayNames.map(function (name, idx) { return (React.createElement("th", { key: "weekDayName-" + idx }, name)); }))),
                            React.createElement("tbody", null, weeks.map(function (week, idx) { return (React.createElement("tr", { "data-testid": "days", key: "rdp-weeks-" + idx }, week.map(function (day, id) { return (React.createElement(Day, __assign({ key: "rdp-days-" + id, "data-testid": "day-" + (idx * 7 + id + 1), "data-fadate": "" + day.faDate, daysEvent: daysEventListeners, theme: theme, startEndRange: rangeDays && rangeDays[day.faDate], isSelecting: isSelecting, selectedDay: selectedDay === day.faDate, holiday: _this.props.holiday.filter(function (holiday) { return holiday === id; }) }, boolDataset(day.disable)), !day.disable ? fa$1(day.day) : null)); }))); }))))),
                    isRenderingButtons && (React.createElement(ButtonsDiv, { className: "rdp__buttons", "data-testid": "rdp__buttons" },
                        React.createElement("button", { "data-testid": "submit-button", className: "rdp__button--submit", onClick: onSubmitButton }, "\u062A\u0627\u06CC\u06CC\u062F"),
                        React.createElement("button", { "data-testid": "cancel-button", className: "rdp__button--cancel", onClick: onCancelButton }, "\u0644\u063A\u0648"),
                        timePicker && (React.createElement(ChangeViewButton, { onClick: toggleView, "data-testid": "toggle-view" }, timePickerView ? React.createElement(DateIcon, null) : React.createElement(ClockIcon, null))))))));
        };
        Days.defaultProps = {
            monthName: "",
            holiday: [],
            daysEventListeners: function () { return null; },
            timePicker: false,
    ...
    var ModalDiv = styled("div")(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  position: absolute;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  top: 0;\n  right: 0;\n  width: 100%;\n  height: 100%;\n  z-index: ", ";\n\n  .rdp__overlay {\n    position: absolute;\n    top: 0;\n    right: 0;\n    width: 100%;\n    height: 100%;\n    z-index: ", ";\n    background-color: rgba(86, 86, 86, 0.4);\n  }\n"], ["\n  position: absolute;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  top: 0;\n  right: 0;\n  width: 100%;\n  height: 100%;\n  z-index: ", ";\n\n  .rdp__overlay {\n    position: absolute;\n    top: 0;\n    right: 0;\n    width: 100%;\n    height: 100%;\n    z-index: ", ";\n    background-color: rgba(86, 86, 86, 0.4);\n  }\n"])), function (props) { return props.modalZIndex; }, function (props) { return props.modalZIndex * -1; });
    var Modal = /** @class */ (function (_super) {
        ...
        Modal.prototype.render = function () {
            var _a = this.props, isOpen = _a.isOpen, toggleOpen = _a.toggleOpen;
            var children = this.props.children;
            if (!isOpen) {
                return null;
            }
            return (React.createElement(ModalDiv, { className: "rdp__modal", modalZIndex: this.props.modalZIndex },
                children,
                React.createElement("div", { "data-testid": "overlay", className: "rdp__overlay", onClick: toggleOpen })));
        };
        Modal.defaultProps = {
            isOpen: false,
        };
    ...
    var ArrowRightCMP = function (props) { return (React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 24 24", "data-testid": "arrow-right" }, props),
        React.createElement("path", { d: "M9.29 15.88L13.17 12 9.29 8.12a.996.996 0 1 1 1.41-1.41l4.59 4.59c.39.39.39 1.02 0 1.41L10.7 17.3a.996.996 0 0 1-1.41 0c-.38-.39-.39-1.03 0-1.42z" }))); };
    var ArrowLeftCMP = function (props) { return (React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 24 24", "data-testid": "arrow-left" }, props),
        React.createElement("path", { d: "M14.71 15.88L10.83 12l3.88-3.88a.996.996 0 1 0-1.41-1.41L8.71 11.3a.996.996 0 0 0 0 1.41l4.59 4.59c.39.39 1.02.39 1.41 0 .38-.39.39-1.03 0-1.42z" }))); };
    var DateIcon = function (props) { return (React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 24 24", "data-testid": "date-icon" }, props),
        React.createElement("path", { fill: "none", d: "M0 0h24v24H0V0z" }),
        React.createElement("path", { d: "M7 11h2v2H7v-2zm14-5v14c0 1.1-.9 2-2 2H5a2 2 0 0 1-2-2l.01-14c0-1.1.88-2 1.99-2h1V2h2v2h8V2h2v2h1c1.1 0 2 .9 2 2zM5 8h14V6H5v2zm14 12V10H5v10h14zm-4-7h2v-2h-2v2zm-4 0h2v-2h-2v2z" }))); };
    var ClockIcon = function (props) { return (React.createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 24 24", "data-testid": "clock-icon" }, props),
        React.createElement("path", { fill: "none", d: "M0 0h24v24H0V0z" }),
    ...
    var stateRange = function (current, start, end) {
    ...
    var makeRangeStatus = function (start, end) {
        var cloneStart = start.clone();
        var cloneEnd = end.clone();
        var startMonth = cloneStart.locale("fa").format("jMMMM");
        var endMonth = cloneEnd.locale("fa").format("jMMMM");
        var startDay = start.format("jDD");
        var endDay = end.format("jDD");
        if (cloneStart.isAfter(end)) {
            return fa$1(startDay) + " " + startMonth + " \u0645\u0627\u0647";
        }
        if (startMonth !== endMonth) {
            return fa$1(startDay) + " " + startMonth + " \u062A\u0627 " + fa$1(endDay) + " " + endMonth;
        }
        return fa$1(startDay) + " \u062A\u0627 " + fa$1(endDay) + " " + startMonth + " \u0645\u0627\u0647";
    };
    var datePickerStatus = function (date) {
        var day = date.format("jDD");
        var month = date.locale("fa").format("jMMMM");
        return fa$1(day) + " " + month + " \u0645\u0627\u0647";
    };

    var RangeDateDiv = styled$1.div(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  direction: rtl;\n"], ["\n  direction: rtl;\n"])));
    var RangeDatePicker = /** @class */ (function (_super) {
        __extends(RangeDatePicker, _super);
        function RangeDatePicker(props) {
            var _this = _super.call(this, props) || this;
            _this.changeMonth = function (amount) {
            ...
            _this.changeStartDay = function (e) {
                var _a = e.target.dataset, fadate = _a.fadate, disable = _a.disable;
                if (!disable) {
                    _this.setState({
            ...
            _this.changeEndDay = function (e) {
                var fadate = e.target.dataset.fadate;
            ...
            _this.daysEventListeners = function () {
                var isSelecting = _this.state.isSelecting;
                if (!isSelecting) {
                    return {
                        onClick: _this.changeStartDay,
                    };
                }
                else {
                    return {
                        onMouseOver: _this.changeEndDay,
                        onClick: _this.endSelecting,
                    };
                }
            };
            ...
            _this.changeInputValues = function (e, start) {
                if (start === void 0) { start = true; }
                var formattedValue = formatJalaliDate(e.target.value);
                if (start && formatJalaliDate(e.target.value)) {
                    return _this.setState({
                        startDate: formatJalaliDate(e.target.value),
                    });
                }
                else if (formattedValue && formattedValue.isAfter(_this.state.startDate)) {
                    return _this.setState({
            ...
            _this.cancelButton = function () {
                var _a = _this.state.initialRange, start = _a.start, end = _a.end;
                _this.setState({
                    isOpenModal: false,
                    startDate: start,
                    endDate: end,
            ...
            _this.submitButton = function () {
                var _a = _this.state, start = _a.startDate, end = _a.endDate;
                if (_this.props.onClickSubmitButton) {
                    _this.props.onClickSubmitButton({
                        start: start,
                        end: end,
                    });
                }
        ...
        RangeDatePicker.prototype.componentDidMount = function () {
            var _a = daysInMonth(this.state.cloneDays), monthName = _a.monthName, days = _a.days;
            var _b = this.state, start = _b.startDate, end = _b.endDate;
            var rangeDays = rangeHelper({ start: start, end: end });
            var rangeStatus = makeRangeStatus(start, end);
        ...
        RangeDatePicker.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
            if (!prevState.startDate.isSame(this.state.startDate) ||
                !prevState.endDate.isSame(this.state.endDate)) {
                var _a = this.state, start = _a.startDate, end = _a.endDate;
                var rangeDays = rangeHelper({ start: start, end: end });
                var rangeStatus = makeRangeStatus(start, end);
                this.setState({
                    rangeDays: rangeDays,
            ...
            if (!prevState.cloneDays.isSame(this.state.cloneDays)) {
                var _b = daysInMonth(this.state.cloneDays), monthName_1 = _b.monthName, days_1 = _b.days;
                this.setState(function (prevSetState) {
                    return {
                        days: prevSetState.days.slice(prevSetState.days.length).concat(days_1),
                        monthName: monthName_1,
                    };
                });
            }
        };
        RangeDatePicker.prototype.render = function () {
            var _this = this;
            var _a = this.props, modalZIndex = _a.modalZIndex, ArrowRight = _a.ArrowRight, ArrowLeft = _a.ArrowLeft, theme = _a.theme;
            return (React.createElement(RangeDateDiv, null,
                React.createElement(MaskedInput, { className: "rdp__input--start", "data-testid": "input-start", value: this.state.startDate.format("jYYYY/jMM/jDD"), onClick: this.toggleModalOpen, onChange: function (e) { return _this.changeInputValues(e); }, mask: inputFaDateMask }),
                React.createElement(MaskedInput, { className: "rdp__input--end", "data-testid": "input-end", value: this.state.endDate.format("jYYYY/jMM/jDD"), onChange: function (e) { return _this.changeInputValues(e, false); }, mask: inputFaDateMask }),
                React.createElement(Modal, { isOpen: this.state.isOpenModal, toggleOpen: this.toggleModalOpen, modalZIndex: modalZIndex },
                    React.createElement(Days, { days: this.state.days, monthName: this.state.monthName, rangeDays: this.state.rangeDays, selectedPickerStatus: this.state.rangeStatus, daysEventListeners: this.daysEventListeners, holiday: this.props.weekend, theme: theme, isSelecting: this.state.isSelecting, isRenderingButtons: this.props.isRenderingButtons, ArrowLeft: ArrowLeft, ArrowRight: ArrowRight, increaseMonth: function () { return _this.changeMonth(1); }, decreaseMonth: function () { return _this.changeMonth(-1); }, onCancelButton: this.cancelButton, onSubmitButton: this.submitButton }))));
        };
        RangeDatePicker.defaultProps = {
            start: jalaliMoment().format("jYYYY/jMM/jDD"),
            end: jalaliMoment().format("jYYYY/jMM/jDD"),
            modalZIndex: 9999,
            ArrowLeft: ArrowLeftCMP,
            ArrowRight: ArrowRightCMP,
    ...
    var DatePickerDiv = styled$1.div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  direction: rtl;\n"], ["\n  direction: rtl;\n"])));
    var DatePicker = /** @class */ (function (_super) {
        ...
        function DatePicker(props) {
            ...
            _this.toggleTimePickerView = function () {
                _this.setState(function (prevState) {
                    return {
            ...
            _this.submitButton = function () {
                ...
                _this.setState({
                    isOpenModal: false,
                    initialValue: _this.state.value,
                });
            };
            _this.state = {
                value: jalaliMoment(_this.props.value),
                cloneDays: jalaliMoment(_this.props.value),
                monthName: "",
                days: [],
                isOpenModal: false,
                timePickerView: false,
                dayStatus: datePickerStatus(jalaliMoment(_this.props.value)),
            };
            return _this;
        }
        ...
        DatePicker.prototype.componentDidUpdate = function (prevProps, prevState) {
            if (!prevState.value.isSame(this.state.value)) {
                this.setState({
                    dayStatus: datePickerStatus(jalaliMoment(this.state.value)),
                });
            }
            if (!prevState.cloneDays.isSame(this.state.cloneDays)) {
                var _a = daysInMonth(this.state.cloneDays), monthName_1 = _a.monthName, days_1 = _a.days;
                this.setState(function (prevSetState) {
                    return {
                        days: prevSetState.days.slice(prevSetState.days.length).concat(days_1),
                        monthName: monthName_1,
        ...
        DatePicker.prototype.render = function () {
            var _this = this;
            var _a = this.props, modalZIndex = _a.modalZIndex, ArrowRight = _a.ArrowRight, ArrowLeft = _a.ArrowLeft, DateIcon$$1 = _a.DateIcon, ClockIcon$$1 = _a.ClockIcon, theme = _a.theme, timePicker = _a.timePicker;
            return (React.createElement(DatePickerDiv, null,
                React.createElement(MaskedInput, { className: "dp__input", "data-testid": "input-dp", value: this.state.value.format(timePicker ? formatDateTime : formatDate), mask: timePicker ? inputFaDateWithTimeMask : inputFaDateMask, onClick: this.toggleModalOpen, style: { direction: "ltr" } }),
                React.createElement(Modal, { isOpen: this.state.isOpenModal, toggleOpen: this.toggleModalOpen, modalZIndex: modalZIndex },
                    React.createElement(Days, { days: this.state.days, monthName: this.state.monthName, selectedPickerStatus: this.state.dayStatus, selectedDay: this.state.value.format("jYYYY/jMM/jDD"), daysEventListeners: this.daysEventListeners, holiday: this.props.weekend, theme: theme, isRenderingButtons: true, ArrowLeft: ArrowLeft, ArrowRight: ArrowRight, DateIcon: DateIcon$$1, ClockIcon: ClockIcon$$1, increaseMonth: function () { return _this.changeMonth(1); }, decreaseMonth: function () { return _this.changeMonth(-1); }, toggleView: this.toggleTimePickerView, timePickerView: this.state.timePickerView, onCancelButton: this.cancelButton, onSubmitButton: this.submitButton, timePicker: true }))));
        };
