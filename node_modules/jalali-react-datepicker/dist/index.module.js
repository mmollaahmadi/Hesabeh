import React__default, { cloneElement, createContext, Component, createElement, Fragment, PureComponent } from 'react';
...
var Day = function (props) {
    ...
    if (startEndRange && Object.keys(startEndRange).length) {
        return createElement(StartEndRangeDay, __assign({}, props, daysEvent()));
    }
    else if (holiday.length) {
        return createElement(HolidayDay, __assign({}, props, daysEvent()));
    }
    return createElement(NormalDay, __assign({}, props, daysEvent()));
};
...
var Days = /** @class */ (function (_super) {
    ...
    Days.prototype.render = function () {
        ...
        return (createElement(ThemeProvider$1, { theme: theme },
            createElement(DaysBody, null,
                timePicker && timePickerView ? (createElement("p", { "data-testid": "dp__timePicker" }, "time picker")) : (createElement(Fragment, null,
                    createElement(DaysHead, { "data-testid": "days-head" },
                        createElement(HeadTitle, { "data-testid": "days-head-title" },
                            createElement(ArrowRight, { onClick: decreaseMonth }),
                            createElement("p", { "data-testid": "days-head-title-text" }, monthName),
                            createElement(ArrowLeft, { onClick: increaseMonth })),
                        createElement(HeadRange, { "data-testid": "days-head-range" }, selectedPickerStatus)),
                    createElement(Table, { "data-testid": "table-days", timePicker: timePicker },
                        createElement("thead", null,
                            createElement("tr", null, weekDayNames.map(function (name, idx) { return (createElement("th", { key: "weekDayName-" + idx }, name)); }))),
                        createElement("tbody", null, weeks.map(function (week, idx) { return (createElement("tr", { "data-testid": "days", key: "rdp-weeks-" + idx }, week.map(function (day, id) { return (createElement(Day, __assign({ key: "rdp-days-" + id, "data-testid": "day-" + (idx * 7 + id + 1), "data-fadate": "" + day.faDate, daysEvent: daysEventListeners, theme: theme, startEndRange: rangeDays && rangeDays[day.faDate], isSelecting: isSelecting, selectedDay: selectedDay === day.faDate, holiday: _this.props.holiday.filter(function (holiday) { return holiday === id; }) }, boolDataset(day.disable)), !day.disable ? fa$1(day.day) : null)); }))); }))))),
                isRenderingButtons && (createElement(ButtonsDiv, { className: "rdp__buttons", "data-testid": "rdp__buttons" },
                    createElement("button", { "data-testid": "submit-button", className: "rdp__button--submit", onClick: onSubmitButton }, "\u062A\u0627\u06CC\u06CC\u062F"),
                    createElement("button", { "data-testid": "cancel-button", className: "rdp__button--cancel", onClick: onCancelButton }, "\u0644\u063A\u0648"),
                    timePicker && (createElement(ChangeViewButton, { onClick: toggleView, "data-testid": "toggle-view" }, timePickerView ? createElement(DateIcon, null) : createElement(ClockIcon, null))))))));
    };
    Days.defaultProps = {
        monthName: "",
        holiday: [],
...
var Modal = /** @class */ (function (_super) {
    ...
    Modal.prototype.render = function () {
        ...
        return (createElement(ModalDiv, { className: "rdp__modal", modalZIndex: this.props.modalZIndex },
            children,
            createElement("div", { "data-testid": "overlay", className: "rdp__overlay", onClick: toggleOpen })));
    };
    Modal.defaultProps = {
        isOpen: false,
    };
...
var ArrowRightCMP = function (props) { return (createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 24 24", "data-testid": "arrow-right" }, props),
    createElement("path", { d: "M9.29 15.88L13.17 12 9.29 8.12a.996.996 0 1 1 1.41-1.41l4.59 4.59c.39.39.39 1.02 0 1.41L10.7 17.3a.996.996 0 0 1-1.41 0c-.38-.39-.39-1.03 0-1.42z" }))); };
var ArrowLeftCMP = function (props) { return (createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 24 24", "data-testid": "arrow-left" }, props),
    createElement("path", { d: "M14.71 15.88L10.83 12l3.88-3.88a.996.996 0 1 0-1.41-1.41L8.71 11.3a.996.996 0 0 0 0 1.41l4.59 4.59c.39.39 1.02.39 1.41 0 .38-.39.39-1.03 0-1.42z" }))); };
var DateIcon = function (props) { return (createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 24 24", "data-testid": "date-icon" }, props),
    createElement("path", { fill: "none", d: "M0 0h24v24H0V0z" }),
    createElement("path", { d: "M7 11h2v2H7v-2zm14-5v14c0 1.1-.9 2-2 2H5a2 2 0 0 1-2-2l.01-14c0-1.1.88-2 1.99-2h1V2h2v2h8V2h2v2h1c1.1 0 2 .9 2 2zM5 8h14V6H5v2zm14 12V10H5v10h14zm-4-7h2v-2h-2v2zm-4 0h2v-2h-2v2z" }))); };
var ClockIcon = function (props) { return (createElement("svg", __assign({ width: "1em", height: "1em", viewBox: "0 0 24 24", "data-testid": "clock-icon" }, props),
    createElement("path", { fill: "none", d: "M0 0h24v24H0V0z" }),
    createElement("path", { d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z" }))); };
...
var RangeDatePicker = /** @class */ (function (_super) {
    ...
    RangeDatePicker.prototype.render = function () {
        ...
        return (createElement(RangeDateDiv, null,
            createElement(MaskedInput, { className: "rdp__input--start", "data-testid": "input-start", value: this.state.startDate.format("jYYYY/jMM/jDD"), onClick: this.toggleModalOpen, onChange: function (e) { return _this.changeInputValues(e); }, mask: inputFaDateMask }),
            createElement(MaskedInput, { className: "rdp__input--end", "data-testid": "input-end", value: this.state.endDate.format("jYYYY/jMM/jDD"), onChange: function (e) { return _this.changeInputValues(e, false); }, mask: inputFaDateMask }),
            createElement(Modal, { isOpen: this.state.isOpenModal, toggleOpen: this.toggleModalOpen, modalZIndex: modalZIndex },
                createElement(Days, { days: this.state.days, monthName: this.state.monthName, rangeDays: this.state.rangeDays, selectedPickerStatus: this.state.rangeStatus, daysEventListeners: this.daysEventListeners, holiday: this.props.weekend, theme: theme, isSelecting: this.state.isSelecting, isRenderingButtons: this.props.isRenderingButtons, ArrowLeft: ArrowLeft, ArrowRight: ArrowRight, increaseMonth: function () { return _this.changeMonth(1); }, decreaseMonth: function () { return _this.changeMonth(-1); }, onCancelButton: this.cancelButton, onSubmitButton: this.submitButton }))));
    };
...
export { RangeDatePicker, DatePicker };
